...
INSERT INTO `qa_options` VALUES ('block_ips_write',''),('cache_tagcount',''),('custom_footer',''),('custom_header',''),('custom_in_head',''),('db_version','47'),('event_logger_to_database',''),('feedback_enabled','1'),('flagging_of_posts','1'),('logo_height',''),('logo_show',''),('logo_url',''),('logo_width',''),('nav_activity',''),('nav_ask','1'),('nav_categories',''),('nav_home',''),('nav_hot',''),('nav_qa_is_home',''),('nav_questions','1'),('nav_tags','1'),('nav_unanswered','1'),('nav_users','1'),('neat_urls','5'),('page_size_home','20'),('permit_hide_show','70'),('permit_moderate','100'),('permit_post_q','150'),('show_custom_footer',''),('show_custom_header',''),('show_custom_home',''),('show_custom_in_head',''),('show_custom_sidebar','1'),('show_custom_sidepanel',''),('show_notice_visitor',''),('site_language',''),('site_maintenance',''),('site_theme','Snow'),('site_theme_mobile','Snow'),('site_url','http://localhost/qa/'),('tags_or_categories','tc');
...
-- Dump completed on 2013-04-15 17:25:17
